    ...
    <b-tab>
      <template slot="title">
       ...
       <b-list-group class="list-group-accent">
        ...
        <b-list-group-item class="list-group-item-accent-info bg-light text-center font-weight-bold text-muted text-uppercase small">
          Translations
        </b-list-group-item>
...
export default {
  ...
  watch: {
    identifier_selected(value) {
      ...
      // console.log(this.$_.isEqual(JSON.parse(parsed),get_identifier))
