  ...
  <div class="container-fluid">
    ...
    <b-row class="hero-banner-wrapper">
      <b-col cols="12">
        ...
        <h2 class="text-center text-white mt-4 mb-4">THE NOBLE QUR'AN</h2>
    ...
    <div class="container">
    <b-row class="mt-3 mb-5 sura-lists">
          
          <b-col cols="12" class="mb-3 mb-0"><h5 class="text-uppercase font-weight-bold">Surah List</h5></b-col>

          <b-col cols="12" md="6" lg="3" class="mb-2" v-for="item in SurahList" :key="item.number">

            <b-card bg-variant="white" text-variant="green" class="text-left">

            <router-link
                    v-if="item.englishName"
                    :to="{ name: 'Surah', params: { surah_id: parseInt(item.number) }}"
                    tag="a"
                    active-class="active" class="sura-link">
              <b-card-text class="text-muted">{{item.number}} <span class="number-of-ayahs">AYAHS: {{item.numberOfAyahs}}</span></b-card-text>      
              <b-card-text class="font-weight-bold arabic-name">{{item.name}}</b-card-text>      
              <b-card-text class="mb-1 font-weight-bold english-name">{{item.englishName}}</b-card-text>
              <b-card-text class="text-uppercase font-weight-light">{{item.englishNameTranslation}}</b-card-text>
...
export default {
  ...
  data () {
    return {
      ...
      error: null,
      data: [],
      SurahList: this.surahsJson.data
    }
  },
}
</script>